...
def showSingleImage(type, data=None):
	...
	try:
		...
		pass
	img1 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/heads.jpg').resize((220,200), Image.ANTIALIAS))
	img2 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/tails.jpg').resize((220,200), Image.ANTIALIAS))
	img4 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/WeatherImage.png'))
	...
	if type=="weather":
		...
		img3 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/dice/'+type+'.jpg').resize((200,200), Image.ANTIALIAS))
...
def WAEMPOPUP(Service='None', rec='Reciever'):
	...
	if Service=="WhatsApp": PopUProot.iconbitmap("C:/VScode/AI---TroLyAo/master/assets/images/whatsapp.ico")
	else: PopUProot.iconbitmap("C:/VScode/AI---TroLyAo/master/assets/images/email.ico")
...
def UpdateIMAGE():
	...
	os.system('python C:/VScode/AI---TroLyAo/master/modules/avatar_selection.py')
	u = UserData()
	u.extractData()
	ownerPhoto = u.getUserPhoto()
	userProfileImg = ImageTk.PhotoImage(Image.open("C:/VScode/AI---TroLyAo/master/assets/images/avatars/a"+str(ownerPhoto)+".png").resize((120, 120)))

	userPhoto['image'] = userProfileImg
	userIcon = PhotoImage(file="C:/VScode/AI---TroLyAo/master/assets/images/avatars/ChatIcons/a"+str(ownerPhoto)+".png")
...
if __name__ == '__main__':
	...
	cblLightImg = PhotoImage(file='C:/VScode/AI---TroLyAo/master/assets/images/centralButton.png')
	cblDarkImg = PhotoImage(file='C:/VScode/AI---TroLyAo/master/assets/images/centralButton1.png')
	...
	#Settings Button
	sphLight = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images//setting.png")
	sphLight = sphLight.subsample(2,2)
	sphDark = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images//setting1.png")
	...
	#Keyboard Button
	kbphLight = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images/keyboard.png")
	kbphLight = kbphLight.subsample(2,2)
	kbphDark = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images/keyboard1.png")
	...
	#Mic
	micImg = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images/mic.png")
	...
	#Text Field
	TextFieldImg = PhotoImage(file='C:/VScode/AI---TroLyAo/master/assets/images/textField.png')
	...
	#User and Bot Icon
	userIcon = PhotoImage(file="C:/VScode/AI---TroLyAo/master/assets/images/avatars/ChatIcons/a"+str(ownerPhoto)+".png")
	botIcon = PhotoImage(file="C:/VScode/AI---TroLyAo/master/assets/images/assistant2.png")
	...
	#User Photo
	userProfileImg = Image.open("C:/VScode/AI---TroLyAo/master/assets/images/avatars/a"+str(ownerPhoto)+".png")
	...
	#Change Photo
	chngPh = ImageTk.PhotoImage(Image.open("C:/VScode/AI---TroLyAo/master/assets/images/avatars/changephoto2.png").resize((120, 120)))
	...
	cimg = PhotoImage(file = "C:/VScode/AI---TroLyAo/master/assets/images/colorchooser.png")
