...
if __name__ == "__main__":
	...
	avtr1 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a1.png').resize((size, size)), Image.ANTIALIAS)
	avtr2 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a2.png').resize((size, size)), Image.ANTIALIAS)
	avtr3 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a3.png').resize((size, size)), Image.ANTIALIAS)
	avtr4 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a4.png').resize((size, size)), Image.ANTIALIAS)
	avtr5 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a5.png').resize((size, size)), Image.ANTIALIAS)
	avtr6 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a6.png').resize((size, size)), Image.ANTIALIAS)
	avtr7 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a7.png').resize((size, size)), Image.ANTIALIAS)
	avtr8 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a8.png').resize((size, size)), Image.ANTIALIAS)
	avtr9 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a9.png').resize((size, size)), Image.ANTIALIAS)
	avtr10 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a10.png').resize((size, size)), Image.ANTIALIAS)
	avtr11 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a11.png').resize((size, size)), Image.ANTIALIAS)
	avtr12 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a12.png').resize((size, size)), Image.ANTIALIAS)
	avtr13 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a13.png').resize((size, size)), Image.ANTIALIAS)
	avtr14 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a14.png').resize((size, size)), Image.ANTIALIAS)
	avtr15 = ImageTk.PhotoImage(Image.open('C:/VScode/AI---TroLyAo/master/assets/images/avatars/a15.png').resize((size, size)), Image.ANTIALIAS)
	...
	avtrRoot.iconbitmap("C:/VScode/AI---TroLyAo/master/assets/images/changeProfile.ico")
	avtrRoot.mainloop()
